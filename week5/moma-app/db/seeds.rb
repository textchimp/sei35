...
a2 = Artist.create! name: 'Frantisek Kupka', nationality: 'Czech', dob: '1871/09/23', period: '20th Century', image: 'https://upload.wikimedia.org/wikipedia/commons/0/05/Frantisek_Kupka_1928.jpg', roundness: 6, bio: 'Vorticist/Abstract'
...
# Krasner
Work.create! title: 'Gothic Landscape', year: '1961/01/01', medium: 'oil on canvas', style: 'abstract expressionism', image: 'http://www.tate.org.uk/art/images/work/T/T03/T03291_10.jpg'
